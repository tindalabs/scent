...
// POST /v1/resolve — submit a snapshot and get back identity + confidence
// without persisting. Useful for login flow integration where you want
// to check confidence before committing the observation to history.
